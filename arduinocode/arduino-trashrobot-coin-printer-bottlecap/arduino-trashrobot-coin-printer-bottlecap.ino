//TRASH:
char coin[] = "";
...
void geometronAction(char action){
  ...
  if(action == 'A'){
    geometronSequence("ggdhhfe");
  }
  if(action == 'B'){
    geometronSequence("ggchhfe");
  }
  if(action == 'C'){
    geometronSequence("ggbhhfe");
  }
  if(action == 'D'){
    geometronSequence("ggahhfe");
  }
  if(action == 'E'){
